...
$string['reportresendsuccessful'] = 'Report resend was successful';
$string['reportsuccessful'] = 'Report successful. Reference number is {$a->externalid}.';
$string['resend'] = 'Resend report';
$string['statusnew'] = 'New, pending being sent to Assyst. May indicate a problem with the Assyst API.';
