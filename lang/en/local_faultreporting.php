...
$string['confirmdelete'] = 'Permanently delete this fault report?';
$string['confirmresend'] = 'Resend this fault report to the external system?';
...
$string['reportcount'] = 'There are currently {$a} report(s).';
...
$string['statuscodenew'] = 'Pending';
$string['statuscodesendfailure'] = 'Error';
$string['statuscodesent'] = 'Ok';
